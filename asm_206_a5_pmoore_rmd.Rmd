...
!["Young salamander surveying a crunchy landscape: a wet leaf"](salamander.jpg)
...
annual_abundance <- ggplot(salamander_count, 
  ...
  labs(x = "Year", 
       ...
       caption = "***Figure 1. Salamander Annual abundance from 1993-2007 in Mack Creek. Dark bars represent counts of salamanders in sections of the creek that were characterized by clear cut forest and lighter bars indicate salamander counts in creek sections characterized by old growth forests.***") +
  theme_bw() +
